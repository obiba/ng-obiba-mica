...
(function () {
    ...
    ngObibaMica.search
        ...
        'LocalizedValues',
        'options',
        function ($timeout, $scope, $rootScope, $location, $translate, $filter, $cookies, ngObibaMicaSearchTemplateUrl, AlertService, LocalizedValues, options) {
