...
angular.module('ngObibaMica', [
  'obiba.mica.dataAccessRequest',
  'ng-obiba'
]);
;angular.module('templates-main', ['access/views/data-access-request-form.html', 'access/views/data-access-request-histroy-view.html', 'access/views/data-access-request-list.html', 'access/views/data-access-request-validation-modal.html', 'access/views/data-access-request-view.html']);
...
angular.module("access/views/data-access-request-view.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("access/views/data-access-request-view.html",
    ...
    "        <div ng-include=\"'app/access/views/data-access-request-histroy-view.html'\"></div>\n" +
    "      </tab>\n" +
    "    </tabset>\n" +
    "  </div>\n" +
    "\n" +
