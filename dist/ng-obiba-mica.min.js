...
IN:"in",OUT:"out",EQ:"eq",GT:"gt",GE:"ge",LT:"lt",LE:"le",BETWEEN:"between",MATCH:"match",EXISTS:"exists",MISSING:"missing"},VOCABULARY_TYPES={STRING:"string",INTEGER:"integer"},CriteriaIdGenerator={generate:function(a,b,c){return a&&b?a.name+"."+b.name+(c?"."+c.name:""):void 0}};/**
...
function a(a){var b=a.args.filter(function(a){switch(a.name){case RQL_NODE.AND:case RQL_NODE.NAND:case RQL_NODE.OR:case RQL_NODE.NOR:case RQL_NODE.NOT:case RQL_NODE.IN:case RQL_NODE.OUT:case RQL_NODE.EQ:case RQL_NODE.GT:case RQL_NODE.GE:case RQL_NODE.LT:case RQL_NODE.LE:case RQL_NODE.BETWEEN:case RQL_NODE.MATCH:case RQL_NODE.EXISTS:case RQL_NODE.MISSING:return!0}return!1}).pop();return b?a.args.findIndex(function(a){return a.name===b.name}):-1}function b(a,b,c){var d=c;return a.attributes&&a.attributes.some(function(a){return a.key===b?(d=a.value,!0):!1}),d}var c=this;this.vocabularyTermNames=function(a){return a&&a.terms?a.terms.map(function(a){return a.name}):[]},this.hasTargetQuery=function(a){return a.args.filter(function(a){switch(a.name){case RQL_NODE.VARIABLE:case RQL_NODE.DATASET:case RQL_NODE.STUDY:case RQL_NODE.NETWORK:return!0;default:return!1}}).length>0},this.variableQuery=function(){return new RqlQuery(QUERY_TARGETS.VARIABLE)},this.eqQuery=function(a,b){var c=new RqlQuery(RQL_NODE.EQ);return c.args.push(b),c},this.aggregate=function(a){var b=new RqlQuery(RQL_NODE.AGGREGATE);return a.forEach(function(a){b.args.push(a)}),b},this.limit=function(a,b){var c=new RqlQuery(RQL_NODE.LIMIT);return c.args.push(a),c.args.push(b),c},this.inQuery=function(a,b){var c=b&&b.length>0,d=c?RQL_NODE.IN:RQL_NODE.EXISTS,e=new RqlQuery(d);return e.args.push(a),c&&e.args.push(b),e},this.rangeQuery=function(a,b,d){var e=new RqlQuery(RQL_NODE.BETWEEN);return e.args.push(a),c.updateRangeQuery(e,b,d),e},this.updateInQuery=function(a,b,c){var d=b&&b.length>0;return a.name=d?RQL_NODE.IN:c?RQL_NODE.MISSING:RQL_NODE.EXISTS,d?a.args[1]=b:a.args.splice(1,1),a},this.mergeInQueryArgValues=function(a,b){var c=b&&b.length>0;if(a.name=c?RQL_NODE.IN:RQL_NODE.EXISTS,c){var d=a.args[1];if(d){d instanceof Array||(d=[d]);var e=b.filter(function(a){return-1===d.indexOf(a)});a.args[1]=d.concat(e)}else a.args[1]=b}else a.args.splice(1,1);return a},this.updateRangeQuery=function(a,b,c,d){d?(a.name=RQL_NODE.MISSING,a.args.splice(1,1)):angular.isDefined(b)&&null!==b&&angular.isDefined(c)&&null!==c?(a.name=RQL_NODE.BETWEEN,a.args[1]=[b,c]):angular.isDefined(b)&&null!==b?(a.name=RQL_NODE.GE,a.args[1]=b):angular.isDefined(c)&&null!==c?(a.name=RQL_NODE.LE,a.args[1]=c):(a.name=RQL_NODE.EXISTS,a.args.splice(1,1))},/**
     ...
     * @returns {RqlQuery}
     */
this.buildRqlQuery=function(a){return c.isNumericVocabulary(a.vocabulary)?this.rangeQuery(this.criteriaId(a.taxonomy,a.vocabulary),null,null):this.inQuery(this.criteriaId(a.taxonomy,a.vocabulary),a.term?a.term.name:this.vocabularyTermNames(a.vocabulary))},/**
...
this.updateCriteriaItem=function(a,b){d.updateQueryArgValues(a.rqlQuery,b.term?[b.term.name]:d.vocabularyTermNames(b.vocabulary))},/**
       ...
       */
this.builders=function(d,e,f,g){function h(a,b){var e=new CriteriaBuilder(a,b,i[d],c,g);e.initialize(d),e.build(),j.resolve({root:e.getRootItem(),map:e.getLeafItemMap()})}var j=a.defer();return i[d]?h(e,f):b.get({target:d}).$promise.then(function(a){i[d]=a,h(e,f)}),j.promise},/**
...
var f;
// facet
return c.args.forEach(function(a){"study"===a.name&&(f=a)}),f||(f=new RqlQuery("study"),c.args.push(f)),f.args.push(d),f.args.push(e),c.args.push(new RqlQuery("facet")),c.serializeArgs(c.args)},this.getTargetAggregations=function(a,b){/**
         ...
         */
function e(a,b){var d=b.terms;if(d&&d.length>0){var e=a.map(function(a){return a.key}),f=[];return d.forEach(function(a){-1===e.indexOf(a.name)&&f.push({count:0,"default":0,description:c.forLocale(a.description,"en"),// TODO use locale provider
key:a.name,title:c.forLocale(a.title,"en")})}),a.concat(f)}return a}var f=d.vocabularyAlias(b.vocabulary),g=a[b.target+"ResultDto"];if(g&&g.aggs){var h=b.taxonomy.name.startsWith("Mica_"),i=h?f:b.taxonomy.name,j=g.aggs.filter(function(a){return a.aggregation===i}).pop();if(j){if(h)return d.isNumericVocabulary(b.vocabulary)?j["obiba.mica.StatsAggregationResultDto.stats"]:e(j["obiba.mica.TermsAggregationResultDto.terms"],b.vocabulary);var k=j.children.filter(function(a){return a.aggregation===f}).pop();if(k)return e(k["obiba.mica.TermsAggregationResultDto.terms"],b.vocabulary)}}return e([],b.vocabulary)}}]),/**
 * Module services and factories
 */
angular.module("obiba.mica.search").factory("TaxonomiesSearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesSearchResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomiesResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("JoinQuerySearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQuerySearchResource"),{},{variables:{method:"GET",errorHandler:!0,params:{type:"variables"}},studies:{method:"GET",errorHandler:!0,params:{type:"studies"}},networks:{method:"GET",errorHandler:!0,params:{type:"networks"}},datasets:{method:"GET",errorHandler:!0,params:{type:"datasets"}}})}]).factory("JoinQueryCoverageResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQueryCoverageResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("VocabularyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("VocabularyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).service("SearchContext",function(){var a=null;this.setLocale=function(b){a=b},this.currentLocale=function(){return a}}).service("ObibaSearchConfig",function(){var a={networks:{showSearchTab:1},studies:{showSearchTab:1},datasets:{showSearchTab:1},variables:{showSearchTab:1}};this.setOptions=function(b){"object"==typeof b&&Object.keys(b).forEach(function(c){c in a&&(a[c]=b[c])})},this.getOptions=function(){return angular.copy(a)}});var DISPLAY_TYPES={LIST:"list",COVERAGE:"coverage",GRAPHICS:"graphics"};angular.module("obiba.mica.search").controller("SearchController",["$scope","$timeout","$routeParams","$location","TaxonomiesSearchResource","TaxonomiesResource","TaxonomyResource","VocabularyResource","ngObibaMicaSearchTemplateUrl","ngObibaMicaSearch","JoinQuerySearchResource","JoinQueryCoverageResource","AlertService","ServerErrorUtils","LocalizedValues","ObibaSearchConfig","RqlQueryService","RqlQueryUtils","SearchContext",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){function t(a){m.alert({id:"SearchController",type:"danger",msg:n.buildMessage(a),delay:5e3})}function u(a){if(!a||!QUERY_TYPES[a.toUpperCase()])throw new Error("Invalid type: "+a)}function v(a){if(!a||!DISPLAY_TYPES[a.toUpperCase()])throw new Error("Invalid display: "+a)}function w(){if(a.settingsDisplay.variables.showSearchTab)return QUERY_TYPES.VARIABLES;var b=Object.keys(a.settingsDisplay).filter(function(b){return 1===a.settingsDisplay[b].showSearchTab});return b[b.length-1]}function x(){try{var b=d.search(),c=b.type||w(),e=b.display||DISPLAY_TYPES.LIST,f=b.query||"";return u(c),v(e),a.search.type=c,a.search.display=e,a.search.query=f,a.search.rqlQuery=(new RqlParser).parse(f),!0}catch(g){m.alert({id:"SearchController",type:"danger",msg:g.message,delay:5e3})}return!1}function y(){if(x()){
// build the criteria UI
q.createCriteria(a.search.rqlQuery,a.lang).then(function(b){
// criteria UI is updated here
console.log(b.root),a.search.criteria=b.root,a.search.criteria&&a.search.criteria.children&&a.search.criteria.children.sort(function(a,b){return"network"===a.target||"variable"===b.target?-1:"variable"===a.target||"network"===b.target?1:a.target<b.target?1:a.target>b.target?-1:0}),a.search.criteriaItemMap=b.map});var b=angular.copy(a.search.rqlQuery);r.addLocaleQuery(b,a.lang);var c=(new RqlQuery).serializeArgs(b.args);switch(a.search.loading=!0,a.search.display){case DISPLAY_TYPES.LIST:k[a.search.type]({query:c},function(b){a.search.result.list=b,a.search.loading=!1},t);break;case DISPLAY_TYPES.COVERAGE:l.get({query:q.prepareCoverageQuery(c,["studyIds"])},function(b){a.search.result.coverage=b,a.search.loading=!1},t);break;case DISPLAY_TYPES.GRAPHICS:k.studies({query:q.prepareGraphicsQuery(c,["methods.designs","populations.selectionCriteria.countriesIso","populations.dataCollectionEvents.bioSamples","numberOfParticipants.participant.number"])},function(b){a.search.result.graphics=b,a.search.loading=!1},t)}}}a.lang=o.getLocal(),j.getLocale(function(b){angular.isArray(b)?(a.tabs=b,a.setLocale(b[0])):a.setLocale(b||a.lang)}),a.setLocale=function(b){a.lang=b,s.setLocale(a.lang),y()},a.settingsDisplay=p.getOptions();var z=function(){angular.element("#taxonomies").collapse("hide")},A=function(b){
// taxonomy filter
return a.taxonomies.search.active=!0,b&&1===b.length?void(a.taxonomies.search.active=!1):void(a.taxonomies.taxonomy?a.taxonomies.vocabulary?h.get({target:a.taxonomies.target,taxonomy:a.taxonomies.taxonomy.name,vocabulary:a.taxonomies.vocabulary.name,query:b},function(b){a.taxonomies.vocabulary.terms=b.terms,a.taxonomies.search.active=!1}):g.get({target:a.taxonomies.target,taxonomy:a.taxonomies.taxonomy.name,query:b},function(b){a.taxonomies.taxonomy.vocabularies=b.vocabularies,a.taxonomies.search.active=!1}):f.get({target:a.taxonomies.target,query:b},function(b){a.taxonomies.all=b,a.taxonomies.search.active=!1}))},B=function(b){a.taxonomiesShown?a.taxonomies.target===b&&z():angular.element("#taxonomies").collapse("show"),a.taxonomies.target!==b&&(a.taxonomies.target=b,a.taxonomies.taxonomy=null,a.taxonomies.vocabulary=null,A(a.taxonomies.search.text))},C=function(){a.taxonomies.search.text=null,a.taxonomies.search.active=!1,A(null)},D=function(b){switch(b.keyCode){case 27:// ESC
a.taxonomies.search.active||C();break;case 13:// Enter
A(a.taxonomies.search.text)}},E=function(){var b=(new RqlQuery).serializeArgs(a.search.rqlQuery.args),c=d.search();""===b?delete c.query:c.query=b,d.search(c).replace()},F=function(){a.documents.search.text=null,a.documents.search.active=!1},G=function(b){
// search for taxonomy terms
// search for matching variables/studies/... count
return e.get({query:b,locale:a.lang}).$promise.then(function(c){if(c){var d=[],e=0,f=10;if(c.forEach(function(b){var c=b.target,g=b.taxonomy;g.vocabularies&&g.vocabularies.forEach(function(b){b.terms?b.terms.forEach(function(h){d.length<f&&d.push(q.createCriteriaItem(c,g,b,h,a.lang)),e++}):(d.length<f&&d.push(q.createCriteriaItem(c,g,b,null,a.lang)),e++)})}),e>d.length){var g={query:b,total:e,size:f,message:"Showing "+f+" / "+e,status:"has-warning"};d.push(g)}return d}return[]})},H=function(b){if(b.id){var c=CriteriaIdGenerator.generate(b.taxonomy,b.vocabulary),d=a.search.criteriaItemMap[c];d?q.updateCriteriaItem(d,b):q.addCriteriaItem(a.search.rqlQuery,b),E(),a.selectedCriteria=null}else a.selectedCriteria=b.query},I=function(b){switch(b.keyCode){case 27:// ESC
a.documents.search.active&&F();break;default:a.documents.search.text&&G(a.documents.search.text)}},J=function(b,c,d){var e=a.taxonomies.taxonomy&&!b||a.taxonomies.vocabulary&&!c;a.taxonomies.taxonomy=b,a.taxonomies.vocabulary=c,a.taxonomies.term=d,e&&A(a.taxonomies.search.text)},K=function(b,c,d,e){return d&&r.isNumericVocabulary(d)?void H(q.createCriteriaItem(a.taxonomies.target,c,d,null,a.lang)):void H(q.createCriteriaItem(b,c,d,e,a.lang))},L=function(a){if(a){u(a);var b=d.search();b.type=a,d.search(b).replace()}},M=function(a){if(a){v(a);var b=d.search();b.display=a,d.search(b).replace()}},N=function(a){q.removeCriteriaItem(a),E()};a.QUERY_TYPES=QUERY_TYPES,a.search={query:null,rqlQuery:null,type:null,result:{list:null,coverage:null,graphics:null},criteria:[],criteriaItemMap:{},loading:!1},a.documents={search:{text:null,active:!1}},a.taxonomies={all:f.get({target:"variable"}),search:{text:null,active:!1},target:"variable",taxonomy:null,vocabulary:null},a.headerTemplateUrl=i.getHeaderUrl("view"),a.clearFilterTaxonomies=C,a.searchCriteria=G,a.selectCriteria=H,a.searchKeyUp=I,a.filterTaxonomiesKeyUp=D,a.navigateTaxonomy=J,a.selectTaxonomyTarget=B,a.selectTerm=K,a.removeCriteriaItem=N,a.refreshQuery=E,a.closeTaxonomies=z,a.onTypeChanged=L,a.onDisplayChanged=M,a.taxonomiesShown=!1,angular.element("#taxonomies").on("show.bs.collapse",function(){a.taxonomiesShown=!0}),angular.element("#taxonomies").on("hide.bs.collapse",function(){a.taxonomiesShown=!1}),a.$watch("search",function(){y()}),a.$on("$locationChangeSuccess",function(a,b){a!==b&&y()})}]).controller("SearchResultController",["$scope","ObibaSearchConfig",function(a,b){a.settingsDisplay=b.getOptions(),a.selectDisplay=function(b){a.display=b,a.$parent.onDisplayChanged(b)},a.selectTarget=function(b){a.type=b,a.$parent.onTypeChanged(b)},a.QUERY_TYPES=QUERY_TYPES,a.DISPLAY_TYPES=DISPLAY_TYPES,a.$watch("type",function(){a.activeTarget={networks:a.type===QUERY_TYPES.NETWORKS&&a.settingsDisplay.networks.showSearchTab||!1,studies:a.type===QUERY_TYPES.STUDIES&&a.settingsDisplay.studies.showSearchTab||!1,datasets:a.type===QUERY_TYPES.DATASETS&&a.settingsDisplay.datasets.showSearchTab||!1,variables:a.type===QUERY_TYPES.VARIABLES&&a.settingsDisplay.variables.showSearchTab||!1}}),a.$watch("display",function(){a.activeDisplay={list:a.display===DISPLAY_TYPES.LIST||!1,coverage:a.display===DISPLAY_TYPES.COVERAGE||!1,graphics:a.display===DISPLAY_TYPES.GRAPHICS||!1}})}]).controller("CriterionLogicalController",["$scope",function(a){a.updateLogical=function(b){a.item.rqlQuery.name=b,a.$emit(CRITERIA_ITEM_EVENT.refresh)}}]).controller("CriterionDropdownController",["$scope","StringUtils","RqlQueryUtils",function(a,b,c){var d=function(){if(a.state.open){a.state.onClose();var b=a.state.dirty;a.state.open=!1,a.state.dirty=!1,b&&
