...
angular.module("obiba.mica.access",["pascalprecht.translate","obiba.alert","obiba.comments","obiba.mica.attachment","obiba.utils","angularMoment","templates-ngObibaMica"]).config(["$provide",function(a){a.provider("ngObibaMicaAccessTemplateUrl",(new NgObibaMicaTemplateUrlFactory).create({list:{header:null,footer:null},view:{header:null,footer:null},form:{header:null,footer:null}}))}]),angular.module("obiba.mica.access").controller("DataAccessRequestListController",["$rootScope","$scope","DataAccessRequestsResource","DataAccessRequestResource","DataAccessRequestService","NOTIFICATION_EVENTS","SessionProxy","USER_ROLES","ngObibaMicaAccessTemplateUrl",function(a,b,c,d,e,f,g,h,i){var j=function(a){for(var c=0;c<a.length;c++){var d=a[c];if("OPENED"!==d.status)for(var e=0;e<d.statusChangeHistory.length;e++){var f=d.statusChangeHistory[e];"OPENED"===f.from&&"SUBMITTED"===f.to&&(d.submissionDate=f.changedOn)}}b.requests=a,b.loading=!1},k=function(){b.loading=!1};e.getStatusFilterData(function(a){b.REQUEST_STATUS=a}),b.headerTemplateUrl=i.getHeaderUrl("list"),b.footerTemplateUrl=i.getFooterUrl("list"),b.searchStatus={},b.loading=!0,c.query({},j,k),b.actions=e.actions,b.showApplicant=g.roles().filter(function(a){return[h.dao,h.admin].indexOf(a)>-1}).length>0,b.deleteRequest=function(c){b.requestToDelete=c.id,a.$broadcast(f.showConfirmDialog,{titleKey:"data-access-request.delete-dialog.title",messageKey:"data-access-request.delete-dialog.message",messageArgs:[c.title,c.applicant]},c.id)},b.$on(f.confirmDialogAccepted,function(a,e){b.requestToDelete===e&&(d["delete"]({id:b.requestToDelete},function(){b.loading=!0,c.query({},j,k)}),delete b.requestToDelete)})}]).controller("DataAccessRequestViewController",["$rootScope","$scope","$location","$routeParams","$filter","DataAccessRequestResource","DataAccessRequestService","DataAccessRequestStatusResource","DataAccessFormConfigResource","JsonUtils","DataAccessRequestCommentsResource","DataAccessRequestCommentResource","ngObibaMicaUrl","ngObibaMicaAccessTemplateUrl","AlertService","ServerErrorUtils","NOTIFICATION_EVENTS",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q){b.form={schema:null,definition:null,model:{},comments:null};var r=function(a){o.alert({id:"DataAccessRequestViewController",type:"danger",msg:p.buildMessage(a)})},s=function(a){switch(b.selectedTab=a,a){case"form":break;case"comments":t()}},t=function(){b.form.comments=k.query({id:d.id})},u=function(a){k.save({id:d.id},a.message,t,r)},v=function(a){l.update({id:d.id,commentId:a.id},a.message,t,r)},w=function(c){b.commentToDelete=c.id,a.$broadcast(q.showConfirmDialog,{titleKey:"comment.delete-dialog.title",messageKey:"comment.delete-dialog.message",messageArgs:[c.createdBy]},c.id)};b.$on(q.confirmDialogAccepted,function(a,c){b.commentToDelete===c&&l["delete"]({id:d.id,commentId:c},{},t,r)}),b.getDownloadHref=function(a,c){return"/ws/data-access-request/"+b.dataAccessRequest.id+"/attachments/"+c+"/_download"},b.actions=g.actions,b.nextStatus=g.nextStatus,b.selectTab=s,b.submitComment=u,b.updateComment=v,b.deleteComment=w,b.headerTemplateUrl=n.getHeaderUrl("view"),b.footerTemplateUrl=n.getFooterUrl("view"),b.requestDownloadUrl=m.getUrl("DataAccessRequestDownloadPdfResource").replace(":id",b.dataAccessRequest.id),b.getStatusHistoryInfoId=g.getStatusHistoryInfoId,g.getStatusHistoryInfo(function(a){b.getStatusHistoryInfo=a}),b.validForm=!0;var x=function(){return f.get({id:d.id},function(a){try{b.form.model=a.content?JSON.parse(a.content):{}}catch(c){b.validForm=!1,b.form.model={},o.alert({id:"DataAccessRequestViewController",type:"danger",msgKey:"data-access-request.parse-error"})}
// Retrieve form data
return i.get(function(a){b.form.definition=j.parseJsonSafely(a.definition,[]),b.form.schema=j.parseJsonSafely(a.schema,{}),0===b.form.definition.length&&(b.validForm=!1,b.form.definition=[],o.alert({id:"DataAccessRequestViewController",type:"danger",msgKey:"data-access-config.parse-error.definition"})),0===Object.getOwnPropertyNames(b.form.schema).length&&(b.validForm=!1,b.form.schema={readonly:!0},o.alert({id:"DataAccessRequestViewController",type:"danger",msgKey:"data-access-config.parse-error.schema"})),b.form.schema.readonly=!0,b.$broadcast("schemaFormRedraw")},r),a.attachments=a.attachments||[],a})};b.dataAccessRequest=d.id?x():{},b["delete"]=function(){b.requestToDelete=b.dataAccessRequest.id,a.$broadcast(q.showConfirmDialog,{titleKey:"data-access-request.delete-dialog.title",messageKey:"data-access-request.delete-dialog.message",messageArgs:[b.dataAccessRequest.title,b.dataAccessRequest.applicant]},b.requestToDelete)},b.$on(q.confirmDialogAccepted,function(a,d){b.requestToDelete===d&&(f["delete"]({id:b.requestToDelete},function(){c.path("/data-access-requests").replace()}),delete b.requestToDelete)});var y=function(){b.dataAccessRequest=x()},z=function(b,c,d){a.$broadcast(q.showConfirmDialog,{titleKey:"data-access-request.status-change-confirmation.title",messageKey:null!==c?c:"data-access-request.status-change-confirmation.message",messageArgs:null!==d?[e("translate")(d).toLowerCase()]:[]},b)},A=function(a,c){a===c&&h.update({id:b.dataAccessRequest.id,status:a},y,r)};b.submit=function(){b.$broadcast("schemaFormValidate"),b.forms.requestForm.$valid?h.update({id:b.dataAccessRequest.id,status:g.status.SUBMITTED},y,r):o.alert({id:"DataAccessRequestViewController",type:"danger",msgKey:"data-access-request.submit.invalid"})},b.reopen=function(){z(g.status.OPENED,null,"reopen")},b.review=function(){z(g.status.REVIEWED,"data-access-request.status-change-confirmation.message-review",null)},b.approve=function(){z(g.status.APPROVED,null,"approve")},b.reject=function(){z(g.status.REJECTED,null,"reject")},b.$on(q.confirmDialogAccepted,function(a,b){A(g.status.OPENED,b)}),b.$on(q.confirmDialogAccepted,function(a,b){A(g.status.REVIEWED,b)}),b.$on(q.confirmDialogAccepted,function(a,b){A(g.status.APPROVED,b)}),b.$on(q.confirmDialogAccepted,function(a,b){A(g.status.REJECTED,b)}),b.forms={}}]).controller("DataAccessRequestEditController",["$log","$scope","$routeParams","$location","$modal","DataAccessRequestsResource","DataAccessRequestResource","DataAccessFormConfigResource","JsonUtils","AlertService","ServerErrorUtils","SessionProxy","DataAccessRequestService","ngObibaMicaAccessTemplateUrl",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n){var o=function(a,b){var c=b().location.split("/");d.path("/data-access-request/"+c[c.length-1]).replace()},p=function(a){j.alert({id:"DataAccessRequestEditController",type:"danger",msg:k.buildMessage(a)})},q=function(){b.$broadcast("schemaFormValidate"),e.open({scope:b,templateUrl:"access/views/data-access-request-validation-modal.html"})},r=function(){d.path("/data-access-request"+(c.id?"/"+c.id:"s")).replace()},s=function(){b.dataAccessRequest.content=JSON.stringify(b.form.model),b.newRequest?f.save(b.dataAccessRequest,o,p):g.save(b.dataAccessRequest,function(){d.path("/data-access-request"+(b.dataAccessRequest.id?"/"+b.dataAccessRequest.id:"s")).replace()},p)};
// Retrieve form data
