 ...
 * Date: 2016-02-16
 */
"use strict";function NgObibaMicaUrlProvider(){function a(a){var b=a;this.getUrl=function(a){return a in b?b[a]:null}}var b={DataAccessFormConfigResource:"ws/config/data-access-form",DataAccessRequestsResource:"ws/data-access-requests",DataAccessRequestResource:"ws/data-access-request/:id",DataAccessRequestAttachmentDownloadResource:"/ws/data-access-request/:id/attachments/:attachmentId/_download",DataAccessRequestDownloadPdfResource:"/ws/data-access-request/:id/_pdf",DataAccessRequestCommentsResource:"ws/data-access-request/:id/comments",DataAccessRequestCommentResource:"ws/data-access-request/:id/comment/:commentId",DataAccessRequestStatusResource:"ws/data-access-request/:id/_status?to=:status",TempFileUploadResource:"ws/files/temp",TempFileResource:"ws/files/temp/:id",PublishedStudiesSearchResource:"ws/:type/_search",TaxonomiesSearchResource:"ws/taxonomies/_search",TaxonomiesResource:"ws/taxonomies/_filter",TaxonomyResource:"ws/taxonomy/:taxonomy/_filter",VocabularyResource:"ws/taxonomy/:taxonomy/vocabulary/:vocabulary/_filter",JoinQuerySearchResource:"ws/:type/_rql?query=:query",JoinQueryCoverageResource:"ws/variables/_coverage?query=:query"};this.setUrl=function(a,c){a in b&&(b[a]=c)},this.$get=function(){return new a(b)}}/* exported NgObibaMicaTemplateUrlFactory */
function NgObibaMicaTemplateUrlFactory(){function a(a){var b=a;this.getHeaderUrl=function(a){return a in b?b[a].header:null},this.getFooterUrl=function(a){return a in b?b[a].footer:null}}var b={registry:null};b.setHeaderUrl=function(a,b){a in this.registry&&(this.registry[a].header=b)},b.setFooterUrl=function(a,b){a in this.registry&&(this.registry[a].footer=b)},b.$get=function(){return new a(this.registry)},this.create=function(a){return b.registry=a,b}}/**
 * Criteria Item builder
 */
function CriteriaItemBuilder(a,b){/**
   * This is
   */
function c(){d.id=d.taxonomy.name+"."+d.vocabulary.name,d.term?(d.id+="."+d.term.name,d.itemTitle=a.forLocale(d.term.title,d.lang),d.itemDescription=a.forLocale(d.term.description,d.lang),d.itemParentTitle=a.forLocale(d.vocabulary.title,d.lang),d.itemParentDescription=a.forLocale(d.vocabulary.description,d.lang),d.itemTitle||(d.itemTitle=d.term.name),d.itemParentTitle||(d.itemParentTitle=d.vocabulary.name)):(d.itemTitle=a.forLocale(d.vocabulary.title,d.lang),d.itemDescription=a.forLocale(d.vocabulary.description,d.lang),d.itemParentTitle=a.forLocale(d.taxonomy.title,d.lang),d.itemParentDescription=a.forLocale(d.taxonomy.description,d.lang),d.itemTitle||(d.itemTitle=d.vocabulary.name),d.itemParentTitle||(d.itemParentTitle=d.taxonomy.name))}var d={type:null,rqlQuery:null,lang:b||"en",parent:null,children:[]};this.type=function(a){if(!RQL_NODE[a.toUpperCase()])throw new Error("Invalid node type:",a);return d.type=a,this},this.target=function(a){return d.target=a,this},this.parent=function(a){return d.parent=a,this},this.taxonomy=function(a){return d.taxonomy=a,this},this.vocabulary=function(a){return d.vocabulary=a,this},this.term=function(a){return d.term=a,this},this.rqlQuery=function(a){return d.rqlQuery=a,this},this.selectedTerm=function(a){return d.selectedTerms||(d.selectedTerms=[]),d.selectedTerms.push("string"==typeof a?a:a.name),this},this.selectedTerms=function(a){return d.selectedTerms=a.filter(function(a){return a}).map(function(a){return"string"==typeof a?a:a.name}),this},this.build=function(){return d.taxonomy&&d.vocabulary&&c(),d}}/**
...
function CriteriaBuilder(a,b,c,d,e){/**
   ...
   */
this.newCriteriaItemBuilder=function(){return new CriteriaItemBuilder(d,e)},this.initialize=function(f){this.target=f,this.rootRql=a,this.taxonomies=c,this.LocalizedValues=d,this.lang=e,this.rootItem=this.newCriteriaItemBuilder().parent(b).type(this.target).rqlQuery(this.rootRql).target(this.target).build()},/**
...
angular.module("obiba.mica.search",["obiba.alert","ui.bootstrap","pascalprecht.translate","templates-ngObibaMica"]).config(["$provide",function(a){a.provider("ngObibaMicaSearchTemplateUrl",(new NgObibaMicaTemplateUrlFactory).create({list:{header:null,footer:null},view:{header:null,footer:null},form:{header:null,footer:null}}))}]),angular.module("obiba.mica.search").filter("regex",function(){return function(a,b,c){var d=[];try{var e=new RegExp(b);d=a.filter(function(a){return c.some(function(b){return e.test(a[b])})})}catch(f){}return d}}).filter("orderBySelection",function(){return function(a,b){if(!a)return[];var c=[],d=[];return a.forEach(function(a){b[a.key]?c.push(a):d.push(a)}),c.concat(d)}});/* exported QUERY_TYPES */
var QUERY_TYPES={NETWORKS:"networks",STUDIES:"studies",DATASETS:"datasets",VARIABLES:"variables"},QUERY_TARGETS={NETWORK:"network",STUDY:"study",DATASET:"dataset",VARIABLE:"variable"},RQL_NODE={
// target nodes
...
IN:"in",OUT:"out",EQ:"eq",GT:"gt",GE:"ge",LT:"lt",LE:"le",BETWEEN:"between",MATCH:"match",EXISTS:"exists",MISSING:"missing"},VOCABULARY_TYPES={STRING:"string",INTEGER:"integer"};/**
 ...
 */
CriteriaBuilder.prototype.visitLeaf=function(a,b){console.log("CriteriaBuilder.visitLeaf");var c=a.args[0],d=a.args[1],e=this.fieldToVocabulary(c),f=this.buildLeafItem(e.taxonomy,e.vocabulary,d instanceof Array?d:[d],a,b);b.children.push(f)},/**
...
this.addQuery=function(b,c){if(0===b.args.length)b.args.push(c);else{var d=a(b);if(-1===d)b.args.push(c);else{var e=b.args.splice(d,1).pop(),f=new RqlQuery(RQL_NODE.OR);f.args.push(e,c),b.args.push(f)}}return b},this.updateQuery=function(a,b,c){switch(a.name){case RQL_NODE.IN:case RQL_NODE.EXISTS:case RQL_NODE.MISSING:this.updateInQuery(a,b,c)}},this.addLocaleQuery=function(a,b){var c=a.args.filter(function(a){return a.name===RQL_NODE.LOCALE}).pop();if(!c){var d=new RqlQuery("locale");d.args.push(b),a.args.push(d)}},/**
     ...
     * @returns {*}
     */
this.criteriaId=function(a,b){return a.name+"."+b.name},this.vocabularyType=function(a){return b(a,"type",VOCABULARY_TYPES.STRING)},this.vocabularyField=function(a){return b(a,"field",a.name)},this.vocabularyAlias=function(a){return b(a,"alias",a.name)},this.isNumericVocabulary=function(a){return!a.terms&&c.vocabularyType(a)===VOCABULARY_TYPES.INTEGER}}]).service("RqlQueryService",["$q","TaxonomiesResource","LocalizedValues","RqlQueryUtils",function(a,b,c,d){function e(a){switch(a.type){case RQL_NODE.IN:case RQL_NODE.OUT:case RQL_NODE.EQ:case RQL_NODE.GT:case RQL_NODE.GE:case RQL_NODE.LT:case RQL_NODE.LE:case RQL_NODE.BETWEEN:case RQL_NODE.MATCH:case RQL_NODE.EXISTS:case RQL_NODE.MISSING:return!0}return!1}function f(a){var b=a.parent,c=a.rqlQuery,d=c.args,e=a.parent.rqlQuery,g=e.args.indexOf(c);if(-1===g)throw new Error("Criteria node not found: "+a);e.args.splice(g,1),d&&(d instanceof Array?e.args.splice.apply(e.args,[g,0].concat(d)):e.args.splice(g,0,d)),null!==b.parent&&0===e.args.length&&f(b)}function g(a){var b=a.parent,c=a.rqlQuery,d=c.args,e=a.parent.rqlQuery,g=e.args.indexOf(c);if(-1===g)throw new Error("Criteria node not found: "+a);e.args.splice(g,1),d&&(d instanceof Array?e.args.splice.apply(e.args,[g,0].concat(d)):e.args.splice(g,0,d)),0===e.args.length&&f(b)}function h(a){var b=a.parent;if(!b)throw new Error("Cannot remove criteria when parent is NULL");var c=a.rqlQuery,d=a.parent.rqlQuery,e=d.args.indexOf(c);if(-1===e)throw new Error("Criteria node not found: "+a);d.args.splice(e,1),-1!==[RQL_NODE.OR,RQL_NODE.AND,RQL_NODE.NAND,RQL_NODE.NOR].indexOf(b.type)?g(b):0===d.args.length&&f(b)}var i={variable:null,dataset:null,study:null,network:null};/**
       * Removes the item from criteria item tree. This should be from a leaf.
       * @param item
       */
this.removeCriteriaItem=function(a){e(a)&&h(a)},/**
...
this.addCriteriaItem=function(a,b){var c=a.args.filter(function(a){return b.target===a.name}).pop();c||(c=new RqlQuery(RQL_NODE[b.target.toUpperCase()]),a.args.push(c));var e=d.buildRqlQuery(b);return d.addQuery(c,e)},/**
       ...
       */
this.builders=function(d,e,f,g){function h(a,b){var e=new CriteriaBuilder(a,b,i[d],c,g);e.initialize(d),e.build(),j.resolve(e.getRootItem())}var j=a.defer();return i[d]?h(e,f):b.get({target:d}).$promise.then(function(a){i[d]=a,h(e,f)}),j.promise},/**
       ...
       * @returns {*}
       */
this.createCriteria=function(b,c){var e=a.defer(),f=(new CriteriaItemBuilder).type(RQL_NODE.AND).rqlQuery(b).build();if(!d.hasTargetQuery(b))return e.resolve(f),e.promise;var g=[],h=this,i=0;return b.args.forEach(function(a){QUERY_TARGETS[a.name.toUpperCase()]&&g.push(a)}),g.forEach(function(a){h.builders(a.name,a,f,c).then(function(a){f.children.push(a),i++,i===g.length&&e.resolve(f)})}),e.promise},/**
       ...
       */
this.prepareCriteriaTermsQuery=function(a,b){var c=(new RqlParser).parse(a),e=c.args.filter(function(a){return a.name===b.target}).pop();return e&&(e.args.push(d.aggregate([d.criteriaId(b.taxonomy,b.vocabulary)])),e.args.push(d.limit(0,0))),c.args.push(new RqlQuery(RQL_NODE.FACET)),c.serializeArgs(c.args)},/**
