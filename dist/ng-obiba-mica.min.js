 ...
 */
CriteriaBuilder.prototype.visitLeaf=function(a,b){var c=RQL_NODE.MATCH===a.name,d=a.args[c?1:0],e=a.args[c?0:1],f=this.fieldToVocabulary(d),g=this.buildLeafItem(f.taxonomy,f.vocabulary,e instanceof Array?e:[e],a,b);this.leafItemMap[g.id]=g,b.children.push(g)},/**
...
this.buildRqlQuery=function(a){return this.isNumericVocabulary(a.vocabulary)?this.rangeQuery(this.criteriaId(a.taxonomy,a.vocabulary),null,null):this.isMatchVocabulary(a.vocabulary)?this.matchQuery(this.criteriaId(a.taxonomy,a.vocabulary),null):this.inQuery(this.criteriaId(a.taxonomy,a.vocabulary),a.term?a.term.name:void 0)},/**
     ...
     * @returns {*}
     */
this.addQuery=function(b,c,d){if(0===b.args.length)b.args.push(c);else{var e=a(b);if(-1===e)b.args.push(c);else{var f=b.args.splice(e,1).pop(),g=new RqlQuery(d||RQL_NODE.OR);g.args.push(f,c),b.args.push(g)}}return b},this.updateQueryArgValues=function(a,b,c){switch(a.name){case RQL_NODE.IN:case RQL_NODE.EXISTS:this.mergeInQueryArgValues(a,b,c)}},this.updateQuery=function(a,b,c){switch(a.name){case RQL_NODE.IN:case RQL_NODE.EXISTS:case RQL_NODE.MISSING:this.updateInQuery(a,b,c)}},this.addLocaleQuery=function(a,b){var c=a.args.filter(function(a){return a.name===RQL_NODE.LOCALE}).pop();if(!c){var d=new RqlQuery("locale");d.args.push(b),a.args.push(d)}},this.addLimit=function(a,b){var c=a.args.filter(function(a){return a.name===RQL_NODE.LIMIT}).pop();c?c.args=b.args:a.args.push(b)},this.addSort=function(a,b){var c=a.args.filter(function(a){return a.name===RQL_NODE.SORT}).pop();if(!c){var d=new RqlQuery("sort");d.args.push(b),a.args.push(d)}},/**
...
this.criteriaId=function(a,b){return a.name+"."+b.name},this.vocabularyType=function(a){return b(a,"type",VOCABULARY_TYPES.STRING)},this.vocabularyField=function(a){return b(a,"field",a.name)},this.vocabularyAlias=function(a){return b(a,"alias",a.name)},this.isTermsVocabulary=function(a){return c.vocabularyType(a)===VOCABULARY_TYPES.STRING&&a.terms},this.isMatchVocabulary=function(a){return c.vocabularyType(a)===VOCABULARY_TYPES.STRING&&!a.terms},this.isNumericVocabulary=function(a){return!a.terms&&(c.vocabularyType(a)===VOCABULARY_TYPES.INTEGER||c.vocabularyType(a)===VOCABULARY_TYPES.DECIMAL)},this.isRangeVocabulary=function(a){return a.terms&&(c.vocabularyType(a)===VOCABULARY_TYPES.INTEGER||c.vocabularyType(a)===VOCABULARY_TYPES.DECIMAL)}}]).service("RqlQueryService",["$q","TaxonomiesResource","TaxonomyResource","LocalizedValues","RqlQueryUtils",function(a,b,c,d,e){function f(a,b){return b.args.filter(function(b){return b.name===a}).pop()}function g(a){switch(a.type){case RQL_NODE.IN:case RQL_NODE.OUT:case RQL_NODE.EQ:case RQL_NODE.GT:case RQL_NODE.GE:case RQL_NODE.LT:case RQL_NODE.LE:case RQL_NODE.BETWEEN:case RQL_NODE.MATCH:case RQL_NODE.EXISTS:case RQL_NODE.MISSING:return!0}return!1}function h(a){var b=a.parent,c=a.rqlQuery,d=c.args,e=a.parent.rqlQuery,f=e.args.indexOf(c),g=b.children.indexOf(a);if(-1===f||-1===g)throw new Error("Criteria node not found: "+a);b.children.splice(g,1),a.children.forEach(function(a){a.parent=b}),b.children.splice.apply(b.children,[g,0].concat(a.children)),e.args.splice(f,1),d&&(d instanceof Array?e.args.splice.apply(e.args,[f,0].concat(d)):e.args.splice(f,0,d)),null!==b.parent&&0===e.args.length&&h(b)}function i(a){var b=a.parent,c=a.rqlQuery,d=c.args,e=a.parent.rqlQuery,f=e.args.indexOf(c),g=b.children.indexOf(a);if(-1===f||-1===g)throw new Error("Criteria node not found: "+a);b.children.splice(g,1),a.children.forEach(function(a){a.parent=b}),b.children.splice.apply(b.children,[g,0].concat(a.children)),e.args.splice(f,1),d&&(d instanceof Array?e.args.splice.apply(e.args,[f,0].concat(d)):e.args.splice(f,0,d)),0===e.args.length&&h(b)}function j(a){var b=a.parent;if(!b)throw new Error("Cannot remove criteria when parent is NULL");var c=a.rqlQuery,d=a.parent.rqlQuery,e=d.args.indexOf(c);if(-1===e)throw new Error("Criteria node not found: "+a);d.args.splice(e,1),-1!==[RQL_NODE.OR,RQL_NODE.AND,RQL_NODE.NAND,RQL_NODE.NOR].indexOf(b.type)?i(b):0===d.args.length&&h(b)}var k={variable:null,dataset:null,study:null,network:null};/**
       ...
       * @param item
       */
this.removeCriteriaItem=function(a){g(a)?j(a):h(a)},/**
       ...
       */
this.createCriteriaItem=function(a,b,e,f,g){function h(b,c,e){return new CriteriaItemBuilder(d,g).target(a).taxonomy(b).vocabulary(c).term(e)}return angular.isString(b)?c.get({target:a,taxonomy:b}).$promise.then(function(a){return e=a.vocabularies.filter(function(a){return a.name===e})[0],f=e.terms.filter(function(a){return a.name===f})[0],h(a,e,f).build()}):h(b,e,f).build()},/**
       * Adds new item to the item tree
       *
       * @param rootItem
       * @param item
       */
this.addCriteriaItem=function(a,b,c){var d=a.args.filter(function(a){return b.target===a.name}).pop();d||(d=new RqlQuery(RQL_NODE[b.target.toUpperCase()]),a.args.push(d));var f=b.rqlQuery?b.rqlQuery:e.buildRqlQuery(b);return e.addQuery(d,f,c)},/**
       * Update an exising item to the item tree
       *
       * @param rootItem
       * @param item
       */
this.updateCriteriaItem=function(a,b,c){var d;d=b.rqlQuery?b.rqlQuery.args[1]:b.term?[b.term.name]:e.vocabularyTermNames(b.vocabulary),e.updateQueryArgValues(a.rqlQuery,d,c)},/**
       * Builders registry
       *
       * @type {{variable: builders.variable, study: builders.study}}
       */
this.builders=function(c,e,f,g){function h(a,b){var e=new CriteriaBuilder(a,b,k[c],d,g);e.initialize(c),e.build(),i.resolve({root:e.getRootItem(),map:e.getLeafItemMap()})}var i=a.defer();return k[c]?h(e,f):b.get({target:c}).$promise.then(function(a){k[c]=a,h(e,f)}),i.promise},/**
...
this.createCriteria=function(b,c){var d=a.defer(),f=(new CriteriaItemBuilder).type(RQL_NODE.AND).rqlQuery(b).build(),g={};if(!e.hasTargetQuery(b))return d.resolve({root:f,map:g}),d.promise;var h=[],i=this,j=0;return b.args.forEach(function(a){QUERY_TARGETS[a.name.toUpperCase()]&&h.push(a)}),h.forEach(function(a){i.builders(a.name,a,f,c).then(function(a){f.children.push(a.root),g=angular.extend(g,a.map),j++,j===h.length&&d.resolve({root:f,map:g})})}),d.promise},/**
       ...
       */
this.prepareCriteriaTermsQuery=function(a,b,c){var d=(new RqlParser).parse(a),f=d.args.filter(function(a){return a.name===b.target}).pop();return f&&(f.args.push(e.aggregate([e.criteriaId(b.taxonomy,b.vocabulary)])),f.args.push(e.limit(0,0))),d.args.push(new RqlQuery(RQL_NODE.FACET)),c&&e.addLocaleQuery(d,c),d.serializeArgs(d.args)},this.prepareSearchQuery=function(a,b,c,d,g){var h=angular.copy(b),i=typeToTarget(a);e.addLocaleQuery(h,d);var j=f(i,h);j||(j=new RqlQuery(i),h.args.push(j));var k=c[i]||{from:0,size:10};return e.addLimit(j,e.limit(k.from,k.size)),g&&e.addSort(j,g),(new RqlQuery).serializeArgs(h.args)},/**
       ...
       * @returns the new query
       */
this.prepareCoverageQuery=function(a,b){var c,d=(new RqlParser).parse(a),e=new RqlQuery("aggregate");switch(b){case BUCKET_TYPES.NETWORK:c="networkId";break;case BUCKET_TYPES.STUDY:c="studyIds";break;case BUCKET_TYPES.DCE:c="dceIds";break;case BUCKET_TYPES.DATASCHEMA:case BUCKET_TYPES.DATASET:c="datasetId"}var f=new RqlQuery("bucket");f.args.push(c),e.args.push(f);var g;if(d.args.forEach(function(a){g||"variable"!==a.name||(g=a)}),g||(g=new RqlQuery("variable"),d.args.push(g)),g.args.length>0&&"limit"!==g.args[0].name){var h=new RqlQuery("in");h.args.push("Mica_variable.variableType"),b===BUCKET_TYPES.NETWORK||b===BUCKET_TYPES.DATASCHEMA?h.args.push("Dataschema"):h.args.push("Study");var i=new RqlQuery("and");i.args.push(h),i.args.push(g.args[0]),g.args[0]=i}return g.args.push(e),d.serializeArgs(d.args)},this.prepareGraphicsQuery=function(a,b,c){var d=(new RqlParser).parse(a),e=new RqlQuery(RQL_NODE.AGGREGATE);
//bucket
if(b.forEach(function(a){e.args.push(a)}),c&&c.length>0){var f=new RqlQuery(RQL_NODE.BUCKET);c.forEach(function(a){f.args.push(a)}),e.args.push(f)}
// limit
var g=new RqlQuery("limit");g.args.push(0),g.args.push(0);
// study
var h;
// facet
return d.args.forEach(function(a){"study"===a.name&&(h=a)}),h||(h=new RqlQuery("study"),h.args.push(new RqlQuery(RQL_NODE.MATCH)),d.args.push(h)),h.args.push(e),h.args.push(g),d.args.push(new RqlQuery("facet")),d.serializeArgs(d.args)},this.getTargetAggregations=function(a,b,c){/**
         ...
         */
function f(a,b){var e=b.terms;if(e&&e.length>0){var f=a&&a.map(function(a){return a.key})||[];if(a){
// Add the missing terms not present in the aggs list
var g=[];return e.forEach(function(a){(0===f.length||-1===f.indexOf(a.name))&&g.push({count:0,"default":0,description:d.forLocale(a.description,c),key:a.name,title:d.forLocale(a.title,c)})}),a.concat(g)}
// The query didn't have any match, return default empty aggs based on the vocabulary terms
return e.map(function(a){return{count:0,"default":0,description:d.forLocale(a.description,c),key:a.name,title:d.forLocale(a.title,c)}})}return a}function g(a,b){if(a.children){var c=a.children.filter(function(a){return a.hasOwnProperty(b)}).pop();if(c)return c[b]}return null}var h=e.vocabularyAlias(b.vocabulary),i=a[b.target+"ResultDto"];if(i&&i.aggs){var j=b.taxonomy.name.startsWith("Mica_"),k=j?h:b.taxonomy.name,l=i.aggs.filter(function(a){return a.aggregation===k}).pop();if(l){if(j)return e.isNumericVocabulary(b.vocabulary)?l["obiba.mica.StatsAggregationResultDto.stats"]:e.isRangeVocabulary(b.vocabulary)?f(l["obiba.mica.RangeAggregationResultDto.ranges"],b.vocabulary):f(l["obiba.mica.TermsAggregationResultDto.terms"],b.vocabulary);var m=l.children.filter(function(a){return a.aggregation===h}).pop();if(m)return e.isRangeVocabulary(b.vocabulary)?f(g(l,"obiba.mica.RangeAggregationResultDto.ranges"),b.vocabulary):f(g(l,"obiba.mica.TermsAggregationResultDto.terms"),b.vocabulary)}}return f([],b.vocabulary)}}]),/**
 * Module services and factories
 */
angular.module("obiba.mica.search").factory("TaxonomiesSearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesSearchResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomiesResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("TaxonomiesResource"),{},{get:{method:"GET",isArray:!0,errorHandler:!0}})}]).factory("TaxonomyResource",["$resource","ngObibaMicaUrl","$cacheFactory",function(a,b,c){return a(b.getUrl("TaxonomyResource"),{},{get:{method:"GET",errorHandler:!0,cache:c("taxonomyResource")}})}]).factory("JoinQuerySearchResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQuerySearchResource"),{},{variables:{method:"GET",errorHandler:!0,params:{type:"variables"}},studies:{method:"GET",errorHandler:!0,params:{type:"studies"}},networks:{method:"GET",errorHandler:!0,params:{type:"networks"}},datasets:{method:"GET",errorHandler:!0,params:{type:"datasets"}}})}]).factory("JoinQueryCoverageResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("JoinQueryCoverageResource"),{},{get:{method:"GET",errorHandler:!0}})}]).factory("VocabularyResource",["$resource","ngObibaMicaUrl",function(a,b){return a(b.getUrl("VocabularyResource"),{},{get:{method:"GET",errorHandler:!0}})}]).service("SearchContext",function(){var a=null;this.setLocale=function(b){a=b},this.currentLocale=function(){return a}}).service("PageUrlService",["ngObibaMicaUrl","StringUtils",function(a,b){return this.studyPage=function(c){return c?b.replaceAll(a.getUrl("StudyPage"),{":study":c}):""},this.studyPopulationPage=function(c,d){return c?b.replaceAll(a.getUrl("StudyPopulationsPage"),{":study":c,":population":d}):""},this.networkPage=function(c){return c?b.replaceAll(a.getUrl("NetworkPage"),{":network":c}):""},this.datasetPage=function(c,d){var e=("study"===d.toLowerCase()?"study":"harmonization")+"-dataset",f=c?b.replaceAll(a.getUrl("DatasetPage"),{":type":e,":dataset":c}):"";return f},this.VariablePage=function(c){return c?b.replaceAll(a.getUrl("VariablePage"),{":variable":c}):""},this.downloadCoverage=function(c){return b.replaceAll(a.getUrl("JoinQueryCoverageDownloadResource"),{":query":c})},this}]).service("ObibaSearchConfig",function(){var a={networks:{showSearchTab:1},studies:{showSearchTab:1},datasets:{showSearchTab:1},variables:{showSearchTab:1}};this.setOptions=function(b){"object"==typeof b&&Object.keys(b).forEach(function(c){c in a&&(a[c]=b[c])})},this.getOptions=function(){return angular.copy(a)}}),angular.module("obiba.mica.search").controller("SearchController",["$scope","$timeout","$routeParams","$location","TaxonomiesSearchResource","TaxonomiesResource","TaxonomyResource","VocabularyResource","ngObibaMicaSearchTemplateUrl","ngObibaMicaSearch","JoinQuerySearchResource","JoinQueryCoverageResource","AlertService","ServerErrorUtils","LocalizedValues","RqlQueryService","RqlQueryUtils","SearchContext",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r){function s(){function b(a){var b=d.search()[a];return b&&b.split(",").filter(function(a){return a}).map(function(a){return a.trim()})}a.taxonomyNav=[];var c=b("taxonomyTabsOrder");a.taxonomyTabsOrder=(c||a.options.taxonomyTabsOrder).filter(function(a){return D[a]});var e=b("searchTabsOrder");a.searchTabsOrder=e||a.options.searchTabsOrder;var f=b("resultTabsOrder");a.resultTabsOrder=(f||a.options.resultTabsOrder).filter(function(a){return D[a]}),a.metaTaxonomy.$promise.then(function(b){a.taxonomyTabsOrder.forEach(function(c){var d=b.vocabularies.filter(function(a){return a.name===c}).pop();d&&d.terms&&d.terms.forEach(function(b){b.target=c;var d=b.title.filter(function(b){return b.locale===a.lang})[0],e=b.description?b.description.filter(function(b){return b.locale===a.lang})[0]:void 0;b.locale={title:d,description:e},b.terms&&b.terms.forEach(function(b){var c=b.title.filter(function(b){return b.locale===a.lang})[0],d=b.description?b.description.filter(function(b){return b.locale===a.lang})[0]:void 0;b.locale={title:c,description:d}}),a.taxonomyNav.push(b)})})})}function t(a){m.alert({id:"SearchController",type:"danger",msg:n.buildMessage(a),delay:5e3})}function u(a){if(!a||!QUERY_TYPES[a.toUpperCase()])throw new Error("Invalid type: "+a)}function v(a){if(!a||!BUCKET_TYPES[a.toUpperCase()])throw new Error("Invalid bucket: "+a)}function w(a){if(!a||!DISPLAY_TYPES[a.toUpperCase()])throw new Error("Invalid display: "+a)}function x(){return a.taxonomyTypeMap[a.resultTabsOrder[0]]}function y(){
// TODO settings
return BUCKET_TYPES.STUDY}function z(){return a.searchTabsOrder[0]||DISPLAY_TYPES.LIST}function A(){try{var b=d.search(),c=a.resultTabsOrder.indexOf(C[b.type])>-1?b.type:x(),e=b.bucket||y(),f=a.searchTabsOrder.indexOf(b.display)>-1?b.display:z(),g=b.query||"";return u(c),v(e),w(f),a.search.type=c,a.search.bucket=e,a.search.display=f,a.search.query=g,a.search.rqlQuery=(new RqlParser).parse(g),!0}catch(h){m.alert({id:"SearchController",type:"danger",msg:h.message,delay:5e3})}return!1}function B(){if(A()){
// build the criteria UI
p.createCriteria(a.search.rqlQuery,a.lang).then(function(b){
// criteria UI is updated here
a.search.criteria=b.root,a.search.criteria&&a.search.criteria.children&&a.search.criteria.children.sort(function(a,b){return"network"===a.target||"variable"===b.target?-1:"variable"===a.target||"network"===b.target?1:a.target<b.target?1:a.target>b.target?-1:0}),a.search.criteriaItemMap=b.map});var b=p.prepareSearchQuery(a.search.type,a.search.rqlQuery,a.search.pagination,a.lang,"variables"===a.search.type?"name":"acronym."+a.lang);switch(a.search.loading=!0,a.search.display){case DISPLAY_TYPES.LIST:a.search.executedQuery=b,k[a.search.type]({query:b},function(b){a.search.result.list=b,a.search.loading=!1},t);break;case DISPLAY_TYPES.COVERAGE:a.search.executedQuery=p.prepareCoverageQuery(b,a.search.bucket),l.get({query:a.search.executedQuery},function(b){a.search.result.coverage=b,a.search.loading=!1},t);break;case DISPLAY_TYPES.GRAPHICS:a.search.executedQuery=p.prepareGraphicsQuery(b,["Mica_study.populations-selectionCriteria-countriesIso","Mica_study.populations-dataCollectionEvents-bioSamples","Mica_study.numberOfParticipants-participant-number"],["Mica_study.methods-designs"]),k.studies({query:a.search.executedQuery},function(b){a.search.result.graphics=b,a.search.loading=!1},t)}}}a.options=j.getOptions(),a.taxonomyTypeMap={//backwards compatibility for pluralized naming in configs.
variable:"variables",study:"studies",network:"networks",dataset:"datasets"};var C=Object.keys(a.taxonomyTypeMap).reduce(function(b,c){return b[a.taxonomyTypeMap[c]]=c,b},{});a.lang=o.getLocal(),a.metaTaxonomy=g.get({target:"taxonomy",taxonomy:"Mica_taxonomy"});var D={variable:a.options.variables.showSearchTab,dataset:a.options.datasets.showSearchTab,study:a.options.studies.showSearchTab,network:a.options.networks.showSearchTab};s();var E=function(){var a=d.search();delete a.query,d.search(a).replace()};j.getLocale(function(b){angular.isArray(b)?(a.tabs=b,a.setLocale(b[0])):a.setLocale(b||a.lang)}),a.setLocale=function(b){a.lang=b,r.setLocale(a.lang),B()};var F=function(b,c){a.target=b,a.taxonomyName=c},G=function(){a.target=null,a.taxonomyName=null},H=function(){var b=(new RqlQuery).serializeArgs(a.search.rqlQuery.args),c=d.search();""===b?delete c.query:c.query=b,d.search(c).replace()},I=function(){a.documents.search.text=null,a.documents.search.active=!1},J=function(b){
// search for taxonomy terms
// search for matching variables/studies/... count
return e.get({query:b,locale:a.lang,target:a.documents.search.target}).$promise.then(function(c){if(c){var d=[],e=0,f=10;if(c.forEach(function(b){var c=b.target,g=b.taxonomy;g.vocabularies&&g.vocabularies.filter(function(a){
// exclude results which are ids used for relations
return!["dceIds","studyId","studyIds","networkId","datasetId"].filter(function(b){return a.name===b}).pop()}).forEach(function(b){b.terms?b.terms.forEach(function(h){d.length<f&&d.push(p.createCriteriaItem(c,g,b,h,a.lang)),e++}):(d.length<f&&d.push(p.createCriteriaItem(c,g,b,null,a.lang)),e++)})}),e>d.length){var g={query:b,total:e,size:f,message:"Showing "+f+" / "+e,status:"has-warning"};d.push(g)}return d}return[]})},K=function(b,c,d){if(b.id){var e=CriteriaIdGenerator.generate(b.taxonomy,b.vocabulary),f=a.search.criteriaItemMap[e];f?p.updateCriteriaItem(f,b,d):p.addCriteriaItem(a.search.rqlQuery,b,c),H(),a.selectedCriteria=null}else a.selectedCriteria=b.query},L=function(b){switch(b.keyCode){case 27:// ESC
a.documents.search.active&&I();break;default:a.documents.search.text&&J(a.documents.search.text)}},M=function(a){if(a){u(a);var b=d.search();b.type=a,d.search(b).replace()}},N=function(a){if(a){v(a);var b=d.search();b.bucket=a,d.search(b).replace()}},O=function(b,c,d){a.search.pagination[b]={from:c,size:d},B()},P=function(a){if(a){w(a);var b=d.search();b.display=a,d.search(b).replace()}},Q=function(b,c,d,e){c&&M(c),e&&Object.keys(a.search.criteriaItemMap).forEach(function(c){a.search.criteriaItemMap[c].target===b.target&&(p.removeCriteriaItem(a.search.criteriaItemMap[c]),delete a.search.criteriaItemMap[c])}),P(d&&a.search.display?a.search.display:DISPLAY_TYPES.LIST),K(b,RQL_NODE.AND,!0)},R=function(b,c,d,e){return d&&q.isNumericVocabulary(d)?void K(p.createCriteriaItem(b,c,d,null,a.lang)):void K(p.createCriteriaItem(b,c,d,e,a.lang))},S=function(b){a.documents.search.target=b},T=function(a){p.removeCriteriaItem(a),H()};a.QUERY_TYPES=QUERY_TYPES,a.BUCKET_TYPES=BUCKET_TYPES,a.search={pagination:{},query:null,rqlQuery:null,executedQuery:null,type:null,bucket:null,result:{list:null,coverage:null,graphics:null},criteria:[],criteriaItemMap:{},loading:!1},a.documents={search:{text:null,active:!1,target:QUERY_TARGETS.VARIABLE}},a.headerTemplateUrl=i.getHeaderUrl("view"),a.selectSearchTarget=S,a.searchCriteria=J,a.selectCriteria=K,a.searchKeyUp=L,a.showTaxonomy=F,a.clearTaxonomy=G,a.removeCriteriaItem=T,a.refreshQuery=H,a.clearSearchQuery=E,a.onTypeChanged=M,a.onBucketChanged=N,a.onDisplayChanged=P,a.onUpdateCriteria=Q,a.onSelectTerm=R,a.QUERY_TARGETS=QUERY_TARGETS,a.onPaginate=O,a.$watch("search",function(){B()}),a.$on("$locationChangeSuccess",function(a,b){s(),a!==b&&B()})}]).controller("TaxonomiesPanelController",["$scope","VocabularyResource","TaxonomyResource","TaxonomiesResource",function(a,b,c,d){a.metaTaxonomy=c.get({target:"taxonomy",taxonomy:"Mica_taxonomy"}),a.taxonomies={all:[],search:{text:null,active:!1},target:"variable",taxonomy:null,vocabulary:null};var e=function(b,c){var d=b.reduce(function(a,b){return a[b.name]=b,a},{});return a.metaTaxonomy.$promise.then(function(b){var e=b.vocabularies.filter(function(a){return a.name===c})[0];a.taxonomyGroups=e.terms.map(function(b){if(!b.terms){var c=d[b.name];return c?(c.title=b.title,c.description=b.description,{title:null,taxonomies:[c]}):null}var e=b.terms.map(function(a){var b=d[a.name];return b?(b.title=a.title,b.description=a.description,b):null}).filter(function(a){return a}),f=b.title.filter(function(b){return b.locale===a.lang})[0],g=b.description?b.description.filter(function(b){return b.locale===a.lang})[0]:void 0;return{title:f?f.text:null,description:g?g.text:null,taxonomies:e}}).filter(function(a){return a})})},f=function(f){
// taxonomy filter
return a.taxonomies.search.active=!0,f&&1===f.length?void(a.taxonomies.search.active=!1):void(a.taxonomies.taxonomy?a.taxonomies.vocabulary?b.get({target:a.taxonomies.target,taxonomy:a.taxonomies.taxonomy.name,vocabulary:a.taxonomies.vocabulary.name,query:f},function(b){a.taxonomies.vocabulary.terms=b.terms,a.taxonomies.search.active=!1}):c.get({target:a.taxonomies.target,taxonomy:a.taxonomies.taxonomy.name,query:f},function(b){a.taxonomies.taxonomy.vocabularies=b.vocabularies,a.taxonomies.search.active=!1}):d.get({target:a.taxonomies.target,query:f},function(b){a.taxonomies.all=b,e(b,a.taxonomies.target),a.taxonomies.search.active=!1}))},g=function(b,c,d){var e=a.taxonomies.taxonomy&&!b||a.taxonomies.vocabulary&&!c;a.taxonomies.taxonomy=b,a.taxonomies.vocabulary=c,a.taxonomies.term=d,e&&f(a.taxonomies.search.text)},h=function(b,c,d,e){a.onSelectTerm(b,c,d,e)};a.$watchGroup(["taxonomyName","target"],function(b){b[0]&&b[1]?(a.showTaxonomies&&a.showTaxonomies(),a.taxonomies.target=b[1],a.taxonomies.search.active=!1,a.taxonomies.all=null,a.taxonomies.taxonomy=null,a.taxonomies.vocabulary=null,a.taxonomies.term=null,c.get({target:b[1],taxonomy:b[0]},function(b){a.taxonomies.taxonomy=b,a.taxonomies.search.active=!1})):b[1]&&(a.taxonomies.target=b[1],a.taxonomies.search.active=!1,a.taxonomies.all=null,a.taxonomies.taxonomy=null,a.taxonomies.vocabulary=null,a.taxonomies.term=null,d.get({target:a.taxonomies.target},function(b){a.taxonomies.all=b,e(b,a.taxonomies.target),a.taxonomies.search.active=!1}))}),a.navigateTaxonomy=g,a.selectTerm=h}]).controller("SearchResultController",["$scope","ngObibaMicaSearch",function(a,b){function c(b){Object.keys(a.activeTarget).forEach(function(c){a.activeTarget[c].active=b===c})}a.targetTypeMap=a.$parent.taxonomyTypeMap,a.QUERY_TARGETS=QUERY_TARGETS,a.QUERY_TYPES=QUERY_TYPES,a.options=b.getOptions(),a.activeDisplay={},a.activeDisplay[a.display]=!0,a.activeTarget={},a.activeTarget[QUERY_TYPES.VARIABLES]={active:!1,name:QUERY_TARGETS.VARIABLE,totalHits:0},a.activeTarget[QUERY_TYPES.DATASETS]={active:!1,name:QUERY_TARGETS.DATASET,totalHits:0},a.activeTarget[QUERY_TYPES.STUDIES]={active:!1,name:QUERY_TARGETS.STUDY,totalHits:0},a.activeTarget[QUERY_TYPES.NETWORKS]={active:!1,name:QUERY_TARGETS.NETWORK,totalHits:0},a.selectDisplay=function(b){a.activeDisplay={},a.activeDisplay[b]=!0,a.display=b,a.$parent.onDisplayChanged(b)},a.selectTarget=function(b){c(b),a.type=b,a.$parent.onTypeChanged(b)},a.$watchCollection("result",function(){a.result.list&&(a.activeTarget[QUERY_TYPES.VARIABLES].totalHits=a.result.list.variableResultDto.totalHits,a.activeTarget[QUERY_TYPES.DATASETS].totalHits=a.result.list.datasetResultDto.totalHits,a.activeTarget[QUERY_TYPES.STUDIES].totalHits=a.result.list.studyResultDto.totalHits,a.activeTarget[QUERY_TYPES.NETWORKS].totalHits=a.result.list.networkResultDto.totalHits)}),a.$watch("type",function(a){c(a)}),a.$watch("display",function(b){a.activeDisplay={},a.activeDisplay[b]=!0}),a.DISPLAY_TYPES=DISPLAY_TYPES}]).controller("CriterionLogicalController",["$scope",function(a){a.updateLogical=function(b){a.item.rqlQuery.name=b,a.$emit(CRITERIA_ITEM_EVENT.refresh)}}]).controller("CriterionDropdownController",["$scope","$filter","LocalizedValues","RqlQueryUtils","StringUtils",function(a,b,c,d,e){var f=function(){if(a.state.open){a.state.onClose();var b=a.state.dirty;a.state.open=!1,a.state.dirty=!1,b&&
// trigger a query update
a.$emit(CRITERIA_ITEM_EVENT.refresh)}},g=function(){return a.state.open?void f():(a.state.open=!0,void a.state.onOpen())},h=function(){a.$emit(CRITERIA_ITEM_EVENT.deleted,a.criterion)},i=function(a){13===a.keyCode&&f()};a.state=new CriterionState,a.localize=function(b){return c.forLocale(b,a.criterion.lang)},a.localizeCriterion=function(){var d=a.criterion.rqlQuery;if(d.name===RQL_NODE.IN&&a.criterion.selectedTerms&&a.criterion.selectedTerms.length>0)return a.criterion.selectedTerms.map(function(b){if(!a.criterion.vocabulary.terms)return b;var d=a.criterion.vocabulary.terms.filter(function(a){return a.name===b}).pop();return d?c.forLocale(d.title,a.criterion.lang):b}).join(" | ");var e=d.name;switch(d.name){case RQL_NODE.EXISTS:e=":"+b("translate")("any");break;case RQL_NODE.MISSING:e=":"+b("translate")("none");break;case RQL_NODE.EQ:e="="+d.args[1];break;case RQL_NODE.GE:e=">"+d.args[1];break;case RQL_NODE.LE:e="<"+d.args[1];break;case RQL_NODE.BETWEEN:e=":["+d.args[1]+")";break;case RQL_NODE.IN:e="";break;case RQL_NODE.MATCH:e=":match("+d.args[0]+")"}return c.forLocale(a.criterion.vocabulary.title,a.criterion.lang)+e},a.vocabularyType=function(a){return d.vocabularyType(a)},a.onKeyup=i,a.truncate=e.truncate,a.remove=h,a.openDropdown=g,a.closeDropdown=f,a.RqlQueryUtils=d}]).controller("MatchCriterionTermsController",["$scope","RqlQueryService","LocalizedValues","JoinQuerySearchResource","RqlQueryUtils","SearchContext",function(a,b,c,d,e,f){a.lang=f.currentLocale();var g=function(){a.state.dirty=!0,e.updateMatchQuery(a.criterion.rqlQuery,a.match)},h=a.criterion.rqlQuery.args[0];a.match="*"===h?"":h,a.update=g}]).controller("NumericCriterionController",["$scope","RqlQueryService","LocalizedValues","JoinQuerySearchResource","RqlQueryUtils","SearchContext",function(a,b,c,d,e,f){a.lang=f.currentLocale();var g=a.criterion.rqlQuery.args[1];angular.isArray(g)?(a.from=a.criterion.rqlQuery.args[1][0],a.to=a.criterion.rqlQuery.args[1][1]):(a.from=a.criterion.rqlQuery.name===RQL_NODE.GE?g:null,a.to=a.criterion.rqlQuery.name===RQL_NODE.LE?g:null);var h=function(){var c=a.criterion.target,e=b.prepareCriteriaTermsQuery(a.query,a.criterion);d[targetToType(c)]({query:e}).$promise.then(function(c){var d=b.getTargetAggregations(c,a.criterion,a.lang);d&&d["default"]&&(a.min=d["default"].min,a.max=d["default"].max)})},i=function(){h()},j=function(){a.updateSelection()};a.updateSelection=function(){e.updateRangeQuery(a.criterion.rqlQuery,a.from,a.to,a.selectMissing),a.state.dirty=!0},a.selectMissing=a.criterion.rqlQuery.name===RQL_NODE.MISSING,a.state.addOnClose(j),a.state.addOnOpen(i)}]).controller("StringCriterionTermsController",["$scope","RqlQueryService","LocalizedValues","StringUtils","JoinQuerySearchResource","RqlQueryUtils","SearchContext","$filter",function(a,b,c,d,e,f,g,h){a.lang=g.currentLocale();var i=function(b){return-1!==a.checkboxTerms.indexOf(b)},j=function(){a.state.dirty=!0;var b=[];Object.keys(a.checkboxTerms).forEach(function(c){a.checkboxTerms[c]&&b.push(c)}),f.updateQuery(a.criterion.rqlQuery,b)},k=function(){f.updateQuery(a.criterion.rqlQuery,[],RQL_NODE.MISSING===a.selectedFilter),a.state.dirty=!0},l=function(){return a.selectedFilter===RQL_NODE.IN},m=function(){a.state.loading=!0;var c=a.criterion.target,d=b.prepareCriteriaTermsQuery(a.query,a.criterion,a.lang);e[targetToType(c)]({query:d}).$promise.then(function(c){a.state.loading=!1,a.terms=b.getTargetAggregations(c,a.criterion,a.lang),a.terms&&(a.terms.forEach(function(b){a.checkboxTerms[b.key]=a.criterion.selectedTerms&&-1!==a.criterion.selectedTerms.indexOf(b.key)}),a.terms=h("orderBySelection")(a.terms,a.checkboxTerms))})};a.state.addOnOpen(m),a.checkboxTerms={},a.RQL_NODE=RQL_NODE,a.selectedFilter=a.criterion.type,a.isSelected=i,a.updateFilter=k,a.localize=function(b){return c.forLocale(b,a.criterion.lang)},a.truncate=d.truncate,a.isInFilter=l,a.updateSelection=j}]).controller("CoverageResultTableController",["$scope","$location","$q","PageUrlService","RqlQueryUtils","RqlQueryService",function(a,b,c,d,e,f){function g(a,b){switch(a){case BUCKET_TYPES.STUDY:case BUCKET_TYPES.DCE:return d.studyPage(b);case BUCKET_TYPES.NETWORK:return d.networkPage(b);case BUCKET_TYPES.DATASCHEMA:return d.datasetPage(b,"harmonization");case BUCKET_TYPES.DATASET:return d.datasetPage(b,"study")}return""}function h(){function b(a){var b;return e[a]?(b=0,e[a]=e[a]+1):(b=1,e[a]=1),b}var c={colSpan:a.bucket===BUCKET_TYPES.DCE?3:1,ids:{}},e={};
// adjust the rowspans
return a.result.rows.forEach(function(e){if(c.ids[e.value]=[],a.bucket===BUCKET_TYPES.DCE){var f,h,i=e.value.split(":"),j=e.title.split(":"),k=e.description.split(":");
// study
h=i[0],f=b(h),c.ids[e.value].push({id:h,url:d.studyPage(h),title:j[0],description:k[0],rowSpan:f}),
// population
h=i[0]+":"+i[1],f=b(h),c.ids[e.value].push({id:h,url:d.studyPopulationPage(i[0],i[1]),title:j[1],description:k[1],rowSpan:f}),
// dce
c.ids[e.value].push({id:e.value,title:j[2],url:d.studyPopulationPage(i[0],i[1]),description:k[2],rowSpan:1})}else c.ids[e.value].push({id:e.value,url:g(a.bucket,e.value),title:e.title,description:e.description,rowSpan:1})}),a.bucket===BUCKET_TYPES.DCE&&a.result.rows.forEach(function(a){c.ids[a.value][0].rowSpan>0&&(c.ids[a.value][0].rowSpan=e[c.ids[a.value][0].id]),c.ids[a.value][1].rowSpan>0&&(c.ids[a.value][1].rowSpan=e[c.ids[a.value][1].id])}),c}a.showMissing=!0,a.toggleMissing=function(b){a.showMissing=b},a.selectBucket=function(b){a.bucket=b,a.$parent.onBucketChanged(b)},a.rowspans={},a.getSpan=function(b,c){var d=0;if(c){var e=b+":"+c;return d=a.result.rows.filter(function(a){return a.title.startsWith(e+":")}).length,a.rowspans[e]=d,d}return d=a.result.rows.filter(function(a){return a.title.startsWith(b+":")}).length,a.rowspans[b]=d,d},a.hasSpan=function(b,c){return c?a.rowspans[b+":"+c]>0:a.rowspans[b]>0},a.hasVariableTarget=function(){var a=b.search().query;return a&&e.hasTargetQuery((new RqlParser).parse(a),RQL_NODE.VARIABLE)},a.hasSelected=function(){return a.table&&a.table.rows&&a.table.rows.filter(function(a){return a.selected}).length},a.BUCKET_TYPES=BUCKET_TYPES,a.downloadUrl=function(){return d.downloadCoverage(a.query)},a.$watch("result",function(){a.table={},a.table.cols=[],a.result&&a.result.rows&&(a.table=a.result,a.table.cols=h())});var i={};i[BUCKET_TYPES.NETWORK]=QUERY_TARGETS.NETWORK,i[BUCKET_TYPES.STUDY]=QUERY_TARGETS.STUDY,i[BUCKET_TYPES.DCE]=QUERY_TARGETS.VARIABLE,i[BUCKET_TYPES.DATASCHEMA]=QUERY_TARGETS.DATASET,i[BUCKET_TYPES.DATASET]=QUERY_TARGETS.DATASET,a.updateDisplay=function(){b.search("display",DISPLAY_TYPES.LIST)},a.updateCriteria=function(b,c,d,e){for(var g,h=a.bucket===BUCKET_TYPES.DCE?"dceIds":"id",j=a.table.taxonomyHeaders[0].entity,k=0,l=0;l<a.table.vocabularyHeaders.length;l++)if(k+=a.table.vocabularyHeaders[l].termsCount,k>d){g=a.table.vocabularyHeaders[l].entity;break}f.createCriteriaItem(QUERY_TARGETS.VARIABLE,j.name,g.name,c.entity.name).then(function(c){f.createCriteriaItem(i[a.bucket],"Mica_"+i[a.bucket],h,b).then(function(b){a.onUpdateCriteria(c,e,!1,!0),a.onUpdateCriteria(b,e)})})},a.updateFilterCriteria=function(){var b=a.bucket===BUCKET_TYPES.DCE?"dceIds":"id",d=a.table.rows.filter(function(a){return a.selected});c.all(d.map(function(c){return f.createCriteriaItem(i[a.bucket],"Mica_"+i[a.bucket],b,c.value)})).then(function(b){if(b.length){var c=b.reduce(function(a,b){return a?(f.updateCriteriaItem(a,b),a):(b.rqlQuery=e.buildRqlQuery(b),b)},null);a.onUpdateCriteria(c,"variables",!0)}})}}]).controller("GraphicsResultController",["GraphicChartsConfig","GraphicChartsUtils","RqlQueryService","$filter","$scope",function(a,b,c,d,e){var f=function(a,c,d,e,f){var g=b.getArrayByAggregation(a,c),h=g.map(function(a){return a.participantsNbr?[a.title,a.value,a.participantsNbr]:[a.title,a.value]});return h.length>0?(h.unshift(d),angular.extend(f,{title:e}),{data:h,entries:g,options:f,vocabulary:a}):!1},g=a.getOptions().ChartsOptions;e.updateCriteria=function(a,b){c.createCriteriaItem("study","Mica_study",b,a).then(function(a){e.onUpdateCriteria(a,"studies")})},e.$watch("result",function(a){if(e.chartObjects={},e.noResults=!0,a&&a.studyResultDto.totalHits){e.noResults=!1;var b=f("populations-selectionCriteria-countriesIso",a.studyResultDto,[d("translate")(g.geoChartOptions.header[0]),d("translate")(g.geoChartOptions.header[1])],d("translate")(g.geoChartOptions.title)+" (N = "+a.studyResultDto.totalHits+")",g.geoChartOptions.options),c=f("methods-designs",a.studyResultDto,[d("translate")(g.studiesDesigns.header[0]),d("translate")(g.studiesDesigns.header[1]),d("translate")(g.studiesDesigns.header[2])],d("translate")(g.studiesDesigns.title)+" (N = "+a.studyResultDto.totalHits+")",g.studiesDesigns.options),h=f("numberOfParticipants-participant-range",a.studyResultDto,[d("translate")(g.numberParticipants.header[0]),d("translate")(g.numberParticipants.header[1])],d("translate")(g.numberParticipants.title)+" (N = "+a.studyResultDto.totalHits+")",g.numberParticipants.options),i=f("populations-dataCollectionEvents-bioSamples",a.studyResultDto,[d("translate")(g.biologicalSamples.header[0]),d("translate")(g.biologicalSamples.header[1])],d("translate")(g.biologicalSamples.title)+" (N = "+a.studyResultDto.totalHits+")",g.biologicalSamples.options);b&&angular.extend(e.chartObjects,{geoChartOptions:{chartObject:{geoTitle:b.options.title,options:b.options,type:"GeoChart",vocabulary:b.vocabulary,data:b.data,entries:b.entries}}}),c&&angular.extend(e.chartObjects,{studiesDesigns:{chartObject:{options:c.options,type:"google.charts.Bar",data:c.data,vocabulary:c.vocabulary,entries:c.entries}}}),h&&angular.extend(e.chartObjects,{numberParticipants:{chartObject:{options:h.options,type:"PieChart",data:h.data,vocabulary:h.vocabulary,entries:h.entries}}}),i&&angular.extend(e.chartObjects,{biologicalSamples:{chartObject:{options:i.options,type:"PieChart",data:i.data,vocabulary:i.vocabulary,entries:i.entries}}})}})}]).controller("SearchResultPaginationController",["$scope",function(a){function b(){a.maxSize=Math.min(3,Math.ceil(a.totalHits/a.pagination.selected.value))}function c(){var b=a.pagination.selected.value,c=a.pagination.currentPage;a.pagination.from=b*(c-1)+1,a.pagination.to=Math.min(a.totalHits,b*c)}var d=function(){c(),a.onChange&&a.onChange(a.target,(a.pagination.currentPage-1)*a.pagination.selected.value,a.pagination.selected.value)},e=function(){b(),a.pagination.currentPage=1,d()};a.pageChanged=d,a.pageSizeChanged=e,a.pageSizes=[{label:"10",value:10},{label:"20",value:20},{label:"50",value:50},{label:"100",value:100}],a.pagination={selected:a.pageSizes[0],currentPage:1},a.$watch("totalHits",function(){b(),c()})}]);/* global RQL_NODE */
